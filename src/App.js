  ...
  return (
    <Wrapper>
      ...
      <section style={{ background: 'white' }}>
        <h1>Test</h1>
        <p>Aliquip qui cillum mollit laborum ea mollit qui deserunt aute aliquip ipsum laborum. Ea laborum culpa do voluptate aliqua ullamco ex non adipisicing velit non officia. Adipisicing ad esse magna magna irure exercitation officia ex amet eu.</p>
        <div className="wave">
